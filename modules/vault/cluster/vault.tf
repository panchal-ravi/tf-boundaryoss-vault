...
resource "aws_instance" "vault" {
  ...
  provisioner "local-exec" {
    command = "scp -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null -i ${path.root}/private-key/rp-key.pem ubuntu@${self.public_ip}:/home/ubuntu/vault-token ./generated_creds/"
  }
